import { TRIALS_DAYS } from "@/app/lib/config";
    ...
    return (
        <div className="my-[150px] flex flex-col items-center gap-14">
            <div className="flex flex-col items-center gap-6">
                ...
                <p className="text-content-body text-xl text-center">Junte-se à comunidade de criadores profissionais que já estão elevando sua <br />
                    presença online. Teste gratuitamente por{" "}<strong className="text-accent-pink">{TRIALS_DAYS} dias</strong>, sem compromisso!
                </p>
            </div>
