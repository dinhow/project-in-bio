...
export default function CreateLinkForm() {
    ...
    async function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        if (isLinkTaken) return setError("Desculpe, esse link já está sendo usado.");

        const isLinkCreated = await createLink(link);

        if (!isLinkCreated) return setError("Desculpe, não foi possível criar o link. Tente novamente mais tarde.");
